...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/login/login.component.ts"); // import { PayPremiumComponent } from "./pay-premium/pay-premium.component";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./login/login.component */
    "./src/app/login/login.component.ts"); // import { Angular4PaystackModule } from 'angular4-paystack';
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _nav_nav_component__WEBPACK_IMPORTED_MODULE_5__["NavComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_6__["HomeComponent"], // PortalComponent,
      _register_register_component__WEBPACK_IMPORTED_MODULE_16__["RegisterComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_20__["LoginComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_19__["HttpClientModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_10__["MatSidenavModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_11__["MatIconModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_12__["MatTabsModule"], // MatBadgeModule,
      // MatBottomSheetModule,
      _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], // MatButtonToggleModule,
      _angular_material__WEBPACK_IMPORTED_MODULE_17__["MatCardModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_8__["MatSliderModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_13__["MatButtonToggleModule"], // MatCheckboxModule,
      // MatChipsModule,
      _angular_material__WEBPACK_IMPORTED_MODULE_17__["MatDatepickerModule"], _angular_material__WEBPACK_IMPORTED_MODULE_17__["MatNativeDateModule"], // MatInputModule,
      // MatListModule,
      // MatMenuModule,  
      // MatProgressBarModule,
      // MatProgressSpinnerModule,
      // MatRadioModule,
      _angular_material_core__WEBPACK_IMPORTED_MODULE_14__["MatRippleModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_7__["MatToolbarModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_15__["BrowserAnimationsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_17__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_17__["MatSelectModule"], _angular_material__WEBPACK_IMPORTED_MODULE_17__["MatRadioModule"], _angular_material__WEBPACK_IMPORTED_MODULE_17__["MatCardModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_18__["ReactiveFormsModule"]],
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    __webpack_require__.n(crypto_js__WEBPACK_IMPORTED_MODULE_5__); // const crypto:any = require('crypto');


    var HomeComponent =
    /*#__PURE__*/
    function () {
      function HomeComponent(d, r, fb) {
        ...
        this.a = false;
        this.keye = this.fb.group({
          key: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]
        });
      ...
      _createClass(HomeComponent, [{
        ...
        key: "dkoo",
        value: function dkoo(r) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee() {
            var h, sd, byteNumbers, i, byteArray, blob, f, a, url;
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    h = r.toString();
                    sd = atob(r.slice(r.search(',') + 1));
                    byteNumbers = new Array(sd.length);
                    ...
                    f = new File([blob], "momo", {
                      type: h.slice(5, h.search(';'))
                    });
                    console.info(blob);
                    a = this.d.getElementById('low'); // a.setAttribute('href',  'data:'+h.slice(5,h.search(';'))+','+ r); 
                    // a.setAttribute('download', 'encrypted');
                    // a.click();

                    url = window.URL.createObjectURL(f);
                    a = this.d.getElementById('low');
        ...
        value: function ko() {
          ...
          var f = this.selectedFiles; // console.info(f.item(0))

          this.fr.onloadend = function (e) {
            var password = 'disPasswordIsSoSec§ur#!';
            var key = crypto_js__WEBPACK_IMPORTED_MODULE_5__["enc"].Base64.parse('lol');
            var iv = crypto_js__WEBPACK_IMPORTED_MODULE_5__["enc"].Base64.parse("#base64IV#"); // let encrypted = crypto.AES.encrypt(e.target.result, 
            //   this.keye.get('key').value.trim())

            _this.poop = crypto_js__WEBPACK_IMPORTED_MODULE_5__["AES"].encrypt(_this.fr.result, _this.keye.get('key').value.trim()).toString(); // console.info(e.target.result.slice(0, 30) + "  before encryption ")
            // console.info(this.poop  + "  after encryption ")

            var r = _this.poop;

            _this.koo(_this.poop);
          };

          this.fr.readAsDataURL(f.item(0)); //  console.info(f.item(0).name.slice(0,(f.item(0).name.length - 4)))
        }
      }, {
        key: "dko",
        value: function dko() {
          ...
          var key = crypto_js__WEBPACK_IMPORTED_MODULE_5__["enc"].Base64.parse('lol');
          var iv = crypto_js__WEBPACK_IMPORTED_MODULE_5__["enc"].Base64.parse("#base64IV#");

          this.fer.onloadend = function (e) {
            // console.info(e.target.result + "before decrypt")
            //  var decrypted = crypto.AES.decrypt(this.fer.result, 'kol').toString(crypto.enc.Utf8);
            try {
              var decrypted = crypto_js__WEBPACK_IMPORTED_MODULE_5__["AES"].decrypt(_this2.fer.result, _this2.key.get('key').value.trim()).toString(crypto_js__WEBPACK_IMPORTED_MODULE_5__["enc"].Utf8);

              _this2.dkoo(decrypted);
            } catch (e) {
              _this2.a = true;
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"])(_angular_common__WEBPACK_IMPORTED_MODULE_1__["DOCUMENT"]))], HomeComponent);
    /***/
  },
                  ...
                  case 6:
                    _context2.t0 = function (c) {
                      ...
                      if (c == 'Unable to Login') {
                        console.log(c);
                        _this3.document.getElementById('bk').innerHTML = "login";

                        _this3.document.getElementById('bk').removeAttribute('disabled');

                        _this3.document.getElementById('ppp').removeAttribute('disabled');
                      } else {
                        _this3.name = c['fullName'];
                        alert(c['fullName'] + ", You have successfully logged into the Encryption and Decrytion system");

                        _this3.r.navigateByUrl('/home');
                      }
                    };
  ...
  function srcAppRegLogServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function RegLogService(Http, r) {
        ...
        this.server = 'https://insurebeta.herokuapp.com/'; // svr = 'eta.herokuapp.com/';
      ...
      _createClass(RegLogService, [{
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    headers.append('Content-Type', 'applicatiion/json');
                    return _context3.abrupt("return", this.Http.post(this.server + 'reg', cred, {
                      headers: headers
                    }));
        ...
        key: "addReg",
        value: function addReg(r) {
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
          headers.append('Content-Type', 'applicatiion/json');
          return this.Http.post(this.svr + 'addReg', r, {
            headers: headers
          });
        }
      }, {
        key: "addLogin",
        value: function addLogin(d) {
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
          headers.append('Content-Type', 'applicatiion/json');
          return this.Http.post(this.svr + 'addLogin', d, {
            headers: headers
          });
        }
      }]);
  ...
  function srcAppRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onSubmit() {
          ...
          if (e != y) {
            ...
            this.s.addReg(form).subscribe(function (r) {
              console.info(r);
              alert(r);

              _this4.r.navigateByUrl('login');
            });
    ...
    })], RegisterComponent); // alert('Thanks!');
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\angular\Decrypt_Encrypt\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
